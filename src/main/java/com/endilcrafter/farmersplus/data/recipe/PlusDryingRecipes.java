...
public class PlusDryingRecipes {
    public static void register(Consumer<FinishedRecipe> consumer) {
        DryingRecipeBuilder.dryingRecipe(Ingredient.of(PlusItems.APPLE_SLICE.get()), PlusItems.DRIED_APPLE_SLICE.get()).build(consumer);
        DryingRecipeBuilder.dryingRecipe(Ingredient.of(PlusItems.GOLDEN_APPLE_SLICE.get()), PlusItems.DRIED_GOLDEN_APPLE_SLICE.get()).build(consumer);
